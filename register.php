<?php
    ...
    if( !empty($_POST) ){
        try
        {
			...
			//$bio= htmlspecialchars($_POST['isAdmin']);
            ...
            if( $security->passwordsAreSecure() ){
				...
				$error = "We can't register with that password. Maybe you should make it a little longer?";
			}
        }
        catch(Exception $e) {
			$error = $e->getMessage();
	...
	<div class="todoRegister">
		...
		<div class="form form--register">
			<form action="" method="post">
				<h2 class="form__title">To do app —— Register </h2>
